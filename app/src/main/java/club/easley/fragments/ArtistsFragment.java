 ...
 */
public class ArtistsFragment  extends Fragment implements AdapterView.OnItemClickListener, ExpandableListAdapterCallbacks {
...
View v;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        v = inflater.inflate(R.layout.artistsfragment_layout, container, false);
        ...
        Log.d("ARTISTS FRAGMENT", "ONCREATE");
    ...
    public void getSongListAndInit(){
        ...
        for(Song song : fragSongs) {
            Log.d("Artists Name", song.getArtist());
            songMap.put(song.getArtist(),song.getTitle());
        }
...
//        menu.findItem(R.id.action_refresh).setVisible(true);
    ...
    public void onResume() {
        // TODO Auto-generated method stub
        super.onResume();
        Log.d("ARTISTS FRAGMENT", this.getTag());
